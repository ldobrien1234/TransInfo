...
%%% for plotting distance matrices
    ...
    for l=1:4
        ...
        if l==1
            ...
            tirotr_XMDS=XMDS_GW;
            save(fullfile(pwd,filePath,'data.mat'),'tirotr_XMDS','-append')
            exportgraphics(h1,fullfile(pwd,filePath,"tirotr_dist.jpg"));
            exportgraphics(h2,fullfile(pwd,filePath,"tirotr_plot.jpg"));
            savefig(h2,fullfile(pwd,filePath,"tirotr_plot.fig"));
        elseif l==2
            %Add GW matrix to data file
            tirefr_XMDS=XMDS_GW;
            save(fullfile(pwd,filePath,'data.mat'),'tirefr_XMDS','-append')
            exportgraphics(h1,fullfile(pwd,filePath,"tirefr_dist.jpg"));
            exportgraphics(h2,fullfile(pwd,filePath,"tirefr_plot.jpg"));
            savefig(h2,fullfile(pwd,filePath,"tirefr_plot.fig"));
        elseif l==3
            %Add GW matrix to data file
            tirotb_XMDS=XMDS_GW;
            save(fullfile(pwd,filePath,'data.mat'),'tirotb_XMDS','-append')
            exportgraphics(h1,fullfile(pwd,filePath,"tirotb_dist.jpg"));
            exportgraphics(h2,fullfile(pwd,filePath,"tirotb_plot.jpg"));
            savefig(h2,fullfile(pwd,filePath,"tirotb_plot.fig"));
        elseif l==4
            %Add GW matrix to data file
            tirefb_XMDS=XMDS_GW;
            save(fullfile(pwd,filePath,'data.mat'),'tirefb_XMDS','-append')
            exportgraphics(h1,fullfile(pwd,filePath,"tirefb_dist.jpg"));
            exportgraphics(h2,fullfile(pwd,filePath,"tirefb_plot.jpg"));
            savefig(h2,fullfile(pwd,filePath,"tirefb_plot.fig"));
        end
