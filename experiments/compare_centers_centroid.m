...
%                 Default: 'All' (i.e. resultsAll/ and plotsAll/).
%
...
%   compare_centers_centroid('other_images', 'OutputSuffix', 'Other');
%       %the experiments/other_images folder, written to
%       %experiments/resultsOther and experiments/plotsOther
%   compare_centers_centroid('other_images', 'MaxDim', 800, ...
...
addParameter(p, 'OutputSuffix', 'All', @(x) (ischar(x) || isstring(x)) && ~isempty(char(x)));
parse(p, varargin{:});
